...
public:
    ...
    // Choque con obstáculo rectangular (inelástico)
    void verificarChoqueConObstaculo(double ox, double oy, double ancho, double alto, double epsilon);
    ...
    friend class Simulacion;  // para poder modificar 'activa'
};
